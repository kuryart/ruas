...
declare module "@codemirror/state" {
  ...
  export type TransactionFilterSpec = (
    tr: Transaction,
  ) => Transaction | TransactionSpec | readonly (Transaction | TransactionSpec)[]

  export type TransactionExtenderSpec = (
    tr: Transaction,
...
declare module "@codemirror/view" {
  ...
  export type ClipboardInputFilterSpec = Parameters<typeof EditorView.clipboardInputFilter.of>[0]

  export type FocusChangeEffectSpec = Parameters<typeof EditorView.focusChangeEffect.of>[0]
}
...
declare module "@codemirror/commands" {
  export type InvertedEffectsSpec = Parameters<typeof invertedEffects.of>[0]
}

declare module "@codemirror/lang-markdown" {
  export type MarkdownConfig = NonNullable<Parameters<typeof markdown>[0]>
}
